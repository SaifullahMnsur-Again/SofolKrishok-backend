...
class CropTrackViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return CropTrack.objects.filter(land__owner=self.request.user)
    ...
    def perform_update(self, serializer):
        ...
        current_values = {
            'land_id': updated_track.land_id,
            'land_name': updated_track.land.name,
            'crop_name': updated_track.crop_name,
            'season': updated_track.season,
            'status': updated_track.status,
            'planted_date': str(updated_track.planted_date) if updated_track.planted_date else None,
            'expected_harvest_date': str(updated_track.expected_harvest_date) if updated_track.expected_harvest_date else None,
            'actual_harvest_date': str(updated_track.actual_harvest_date) if updated_track.actual_harvest_date else None,
